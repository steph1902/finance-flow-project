...
export class AiCategorizationProcessor extends WorkerHost {
     ...
     */
    async process(job: Job<CategorizationJobData>): Promise<{ category: string; confidence: number }> {
...
No explanation, no markdown, just the JSON object.`;
     ...
     */
    private fallbackCategorization(description: string, type: string): { category: string; confidence: number } {
