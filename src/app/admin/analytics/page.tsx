            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <Card className="max-w-md">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Demo account hasn't been used yet. Login with the demo account to generate analytics data.
                        </CardDescription>
                    </CardHeader>
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardTitle className="text-3xl">{data.summary.totalEvents}</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardTitle className="text-3xl">{data.summary.loginCount}</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardTitle className="text-3xl">{data.summary.uniqueSessions}</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardTitle className="text-3xl">{data.eventsByCountry?.length || 0}</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center text-sm text-muted-foreground">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Most popular actions in demo account</CardDescription>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    data.eventsByCountry.map((location) => (
                                        <div key={location.country} className="space-y-2">
                                            <div className="flex justify-between text-sm">
                                                ...
                                                <span className="text-muted-foreground">{location.count} events</span>
                                            </div>
