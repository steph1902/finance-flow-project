...
export const GET = withApiAuth(async (request, userId) => {
    try {
        ...
        const getKeyStatus = (dbKey: string | undefined, envKey: string | undefined) => {
            return dbKey || envKey || undefined;
        };

        const keys = {
            "gemini-ai": getKeyStatus(userKeys["gemini-ai"], process.env.GEMINI_API_KEY),
            ...
            "google-oauth": getKeyStatus(userKeys["google-oauth"], process.env.GOOGLE_CLIENT_ID),
