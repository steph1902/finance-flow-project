  ...
  const fetchStats = async () => {
    try {
      const response = await fetch(
        "/api/admin/ai-analytics/categorization-stats",
      );
        ...
        <TabsContent value="categories" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Accuracy and usage statistics per category
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex gap-4 text-sm text-slate-500">
                        <span>
                          Acceptance: {cat.acceptanceRate.toFixed(1)}%
                        </span>
                        <span>
                          Avg Confidence: {cat.avgConfidence.toFixed(1)}%
                        </span>
                      </div>
                    </div>
