...
export default function LogsPage() {
    ...
    return (
        <div className="space-y-6 p-6">
                                ...
                                {loading ? (
                                    ...
                                    logs.map((log) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <div className="max-w-[500px] truncate font-medium" title={log.message}>
                                                    {log.message}
                                                </div>
                                            </TableCell>
            ...
            {/* Log Details Dialog */}
            {selectedLog && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 sm:p-6" onClick={() => setSelectedLog(null)}>
                    <Card className="w-full max-w-3xl max-h-[85vh] flex flex-col shadow-xl animate-in fade-in zoom-in duration-200" onClick={(e) => e.stopPropagation()}>
                        ...
                        <CardContent className="flex-1 overflow-auto p-4 sm:p-6 space-y-6">
                            <div className="space-y-2">
                                <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Message</h3>
                            ...
                            {selectedLog.metadata && Object.keys(selectedLog.metadata).length > 0 && (
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Metadata / Stack Trace</h3>
                                        <Button
                                            variant="outline"
                                            size="sm"
