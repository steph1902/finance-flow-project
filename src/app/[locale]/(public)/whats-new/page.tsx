                    ...
                    <div className="space-y-12">
                        {loading ? (
                            ...
                            versions.map((version, index) => (
                                ...
                                >
                                    {/* Timeline Dot */}
                                    <div className={`absolute left-[31px] top-6 w-4 h-4 rounded-full border-4 border-white shadow-sm hidden md:block ${version.isCurrent ? "bg-green-500 ring-4 ring-green-100" : "bg-neutral-300"
                                        }`}></div>
                                    ...
                                    <Card
                                        className={`border-none shadow-soft overflow-hidden transition-all duration-200 ${expandedVersion === version.id ? "ring-1 ring-neutral-200" : "hover:shadow-md"
                                            }`}
                                    >
                                        <div
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <h3 className="text-xl font-bold text-neutral-900">v{version.version}</h3>
                                                    </div>
                                                    {version.isCurrent && (
                                                ...
                                                <div className="flex items-center gap-4 text-sm text-neutral-500">
                                                    <div className="flex items-center gap-1 md:hidden">
                                                        ...
                                                        {format(new Date(version.deployedAt), "MMM d, yyyy")}
                                                    </div>
