...
export const metadata = {
  ...
  description: "A production-grade examination of architectural decisions, system design rationale, and implementation patterns for enterprise-ready financial intelligence.",
};
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-16 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold leading-tight mb-6">
              ...
              <span className="text-primary italic">Architectural Case Study</span>
            </h1>
          ...
          <div className="bg-card border border-border rounded-2xl p-8 mb-12 shadow-soft">
            ...
            <nav className="space-y-3">
              {[
                { id: "architecture", title: "1. System Architecture Overview", desc: "Hybrid architecture, Fastify vs Express" },
                { id: "ai-pipeline", title: "2. AI Intelligence Pipeline", desc: "Agentic workflow, Gemini 1.5 Flash, fault tolerance" },
                { id: "data-integrity", title: "3. Data Integrity & Schema Design", desc: "PostgreSQL + Prisma, constraints, indexing" },
                { id: "security", title: "4. Production-Grade Resilience & Security", desc: "JWT auth, rate limiting, PWA strategy" },
                { id: "performance", title: "5. Performance Optimization Strategy", desc: "SWR caching, skeleton loaders, cold starts" },
                { id: "future", title: "6. Forward-Deployed Architecture", desc: "Enterprise readiness, expansion vectors" },
              ].map((item) => (
                <a
                  key={item.id}
                  href={`#${item.id}`}
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Constraint</th>
                    <th className="text-left py-3 px-4 font-semibold">Next.js Solution</th>
                    <th className="text-left py-3 px-4 font-semibold">NestJS Solution</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Cold Start Sensitivity</td>
                    <td className="py-3 px-4">Serverless-optimized, edge-deployable</td>
                    <td className="py-3 px-4">Long-running process, no cold starts</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Compute Profile</td>
                    <td className="py-3 px-4">I/O-bound reads, cache-friendly</td>
                    <td className="py-3 px-4">CPU-bound AI inference, blocking operations</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Failure Isolation</td>
                    <td className="py-3 px-4">User-facing degradation is unacceptable</td>
                    <td className="py-3 px-4">Background failures can be retried</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-3 px-4 font-semibold">Fastify</th>
                    <th className="text-left py-3 px-4 font-semibold text-primary">Delta</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
...
└──────────────────────────────────────────────────────────────────────────────┘
  ...
  └─────────────────────────────────────────────────────────────────────────┘`}
            ...
            <h3 className="text-xl font-semibold mb-4">Gemini 1.5 Flash: Classification Engine</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Model Characteristic</th>
                    <th className="text-left py-3 px-4 font-semibold">Value</th>
                    <th className="text-left py-3 px-4 font-semibold">Architectural Implication</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Context Window</td>
                    <td className="py-3 px-4">1M tokens</td>
                    <td className="py-3 px-4">Batch classification of related transactions</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Latency</td>
                    <td className="py-3 px-4">~200-400ms</td>
                    <td className="py-3 px-4">Async processing required for UX</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Accuracy (observed)</td>
                    <td className="py-3 px-4">≈95%</td>
                    <td className="py-3 px-4">Confidence thresholds for edge cases</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Cost</td>
                    <td className="py-3 px-4">Low per-token</td>
                    <td className="py-3 px-4">Viable for high-volume batch processing</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
async function classifyTransaction(tx: RawTransaction) {
  ...
  return { ...tx, category: ruleResult.category, source: 'rule' };
            ...
            <h3 className="text-xl font-semibold mb-4">Fault Tolerance: Designing for Failure</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Failure Mode</th>
                    <th className="text-left py-3 px-4 font-semibold">Mitigation</th>
                    <th className="text-left py-3 px-4 font-semibold">Recovery</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Gemini API timeout</td>
                    <td className="py-3 px-4">10s timeout per request</td>
                    <td className="py-3 px-4">Retry with exponential backoff</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Gemini rate limit</td>
                    <td className="py-3 px-4">Token bucket at 10 req/min</td>
                    <td className="py-3 px-4">Queue backpressure</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Gemini unavailable</td>
                    <td className="py-3 px-4">Circuit breaker (5 fails → open)</td>
                    <td className="py-3 px-4">Rule-based fallback</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Vision OCR failure</td>
                    <td className="py-3 px-4">Mark as &quot;needs review&quot;</td>
          ...
          <section id="data-integrity" className="mb-20 scroll-mt-32">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-3 text-primary">Core Financial</h4>
              ...
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-3 text-primary">Intelligence</h4>
                <ul className="space-y-1 text-sm text-muted-foreground">
                  <li>• AISuggestion</li>
                  <li>• ChatMessage</li>
            ...
            <h3 className="text-xl font-semibold mb-4">Constraint-Driven Integrity</h3>
            <p className="text-muted-foreground mb-6 leading-relaxed">
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Constraint Type</th>
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Composite Unique</td>
                    <td className="py-3 px-4 font-mono text-sm">(userId, category, month)</td>
                    <td className="py-3 px-4">Prevent duplicate budgets</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Foreign Key Cascade</td>
                    <td className="py-3 px-4 font-mono text-sm">Transaction → User</td>
                    <td className="py-3 px-4">Orphan prevention</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Soft Delete</td>
                    <td className="py-3 px-4 font-mono text-sm">deletedAt timestamp</td>
            ...
            <h3 className="text-xl font-semibold mb-4">Query Performance at Scale</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Query Pattern</th>
                    <th className="text-left py-3 px-4 font-semibold">Row Count</th>
                    <th className="text-left py-3 px-4 font-semibold">p50 Latency</th>
                    <th className="text-left py-3 px-4 font-semibold">p99 Latency</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    ...
                    <td className="py-3 px-4 text-green-600 font-medium">12ms</td>
                    <td className="py-3 px-4 text-green-600 font-medium">45ms</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4">Monthly category sum</td>
                    <td className="py-3 px-4">50,000</td>
                    <td className="py-3 px-4 text-green-600 font-medium">8ms</td>
                    <td className="py-3 px-4 text-green-600 font-medium">32ms</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4">Full-text search</td>
                    <td className="py-3 px-4">100,000</td>
                    <td className="py-3 px-4 text-green-600 font-medium">35ms</td>
                    <td className="py-3 px-4 text-green-600 font-medium">89ms</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="security" className="mb-20 scroll-mt-32">
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Security Control</th>
                    <th className="text-left py-3 px-4 font-semibold">Implementation</th>
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    ...
                    <td className="py-3 px-4">GPU-resistant, industry standard</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">JWT Signing</td>
                    <td className="py-3 px-4">RS256 asymmetric</td>
                    <td className="py-3 px-4">Public key verification</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Token Expiry</td>
                    <td className="py-3 px-4">15 min access / 7 day refresh</td>
                    <td className="py-3 px-4">Security vs. UX balance</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Cookie Security</td>
                    <td className="py-3 px-4">HttpOnly, Secure, SameSite=Strict</td>
            ...
            <h3 className="text-xl font-semibold mb-4">Rate Limiting: Tiered Protection</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Endpoint Class</th>
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">AI Classification</td>
                    <td className="py-3 px-4">10</td>
                    <td className="py-3 px-4">1 min</td>
                    <td className="py-3 px-4">Expensive compute, API cost</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">AI Chat</td>
                    <td className="py-3 px-4">5</td>
                    <td className="py-3 px-4">1 min</td>
                    <td className="py-3 px-4">Token-heavy, abuse vector</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">General API</td>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2 text-green-600">CacheFirst</h4>
                <p className="text-sm text-muted-foreground mb-2">Fonts, Images</p>
                <p className="text-sm">Assets are versioned and immutable. Cache hits eliminate network round-trips entirely.</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2 text-blue-600">NetworkFirst</h4>
                <p className="text-sm text-muted-foreground mb-2">API Responses</p>
                <p className="text-sm">Financial data must be fresh. Cache serves as fallback during network failures.</p>
              </div>
            </div>
          </section>
          ...
          <section id="performance" className="mb-20 scroll-mt-32">
            ...
            <h3 className="text-xl font-semibold mb-4">Real vs. Perceived Performance</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Real: Server</td>
                    <td className="py-3 px-4">Prisma connection pooling</td>
                    <td className="py-3 px-4">Eliminates connection overhead</td>
                  </tr>
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Real: Server</td>
                  ...
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Perceived: Client</td>
          ...
          <section id="future" className="mb-20 scroll-mt-32">
            <h2 className="text-3xl font-serif font-bold mb-8 flex items-center gap-3">
              <span className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary text-lg font-bold">6</span>
              Forward-Deployed Architecture
            </h2>

            <h3 className="text-xl font-semibold mb-4">Enterprise Readiness Assessment</h3>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    <th className="text-left py-3 px-4 font-semibold">Capability</th>
                    <th className="text-left py-3 px-4 font-semibold">Current State</th>
                    <th className="text-left py-3 px-4 font-semibold">Enterprise Req</th>
                    <th className="text-left py-3 px-4 font-semibold">Gap</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Horizontal Scaling</td>
                  ...
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Observability</td>
                  ...
                  <tr className="border-b border-border/50">
                    <td className="py-3 px-4 font-medium text-foreground">Multi-Tenancy</td>
            ...
            <h3 className="text-xl font-semibold mb-4">Future Expansion Vectors</h3>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2">Additional AI Agents</h4>
                <p className="text-sm text-muted-foreground">BullMQ supports multiple named queues; new agents register as workers</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2">Advanced Forecasting</h4>
                <p className="text-sm text-muted-foreground">Schema supports time-series storage; Redis for real-time aggregation</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2">Multi-Tenant Deployment</h4>
                <p className="text-sm text-muted-foreground">Row-level security via Prisma middleware; tenant ID injection</p>
              </div>
              <div className="bg-card border border-border rounded-xl p-6">
                <h4 className="font-semibold mb-2">Third-Party Integrations</h4>
                <p className="text-sm text-muted-foreground">NestJS module system supports isolated integration modules</p>
              </div>
            </div>
          ...
          <section className="mt-20 text-center">
            <div className="bg-card border border-border rounded-2xl p-12 shadow-soft">
              <h2 className="text-2xl font-serif font-bold mb-4">Ready to explore the codebase?</h2>
