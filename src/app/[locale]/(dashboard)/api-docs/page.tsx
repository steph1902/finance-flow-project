...
import { Code, Database, Zap, Shield, Sparkles, CheckCircle2, Wallet, MessageSquare } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-12">
                    <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded-full px-4 py-2 mb-4">
                        ...
                        <span className="text-sm font-medium text-indigo-900">Developer Documentation</span>
                    </div>
                    <h1 className="text-5xl font-light tracking-tight text-neutral-900 mb-4">
                        FinanceFlow API Documentation
                    </h1>
                    <p className="text-lg text-neutral-600 max-w-3xl">
                        Complete reference for the FinanceFlow REST API. Build powerful financial applications with our
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <Card className="border-none shadow-soft rounded-[24px]">
                        <CardHeader>
                            ...
                            <CardDescription>
                                JWT authentication, rate limiting, and encrypted data transmission
                            </CardDescription>
                        </CardHeader>
                    </Card>
                ...
                <Tabs defaultValue="quickstart" className="space-y-8">
                    <TabsList className="bg-neutral-100 p-1 rounded-2xl">
                        <TabsTrigger value="quickstart" className="rounded-xl">Quick Start</TabsTrigger>
                        <TabsTrigger value="endpoints" className="rounded-xl">API Endpoints</TabsTrigger>
                        <TabsTrigger value="authentication" className="rounded-xl">Authentication</TabsTrigger>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="bg-neutral-900 text-neutral-100 p-4 rounded-2xl font-mono text-sm overflow-x-auto">
                                        <div className="text-neutral-400">// Include JWT token in Authorization header</div>
                                        <div className="mt-2">
                                ...
                                <div>
                                    ...
                                    <div className="bg-neutral-900 text-neutral-100 p-4 rounded-2xl font-mono text-sm overflow-x-auto">
                                        ...
                                        <div className="pl-4 text-neutral-300">
                                            -H <span className="text-green-400">&quot;Authorization: Bearer YOUR_JWT_TOKEN&quot;</span>
                                        </div>
                                        <div className="pl-4 text-neutral-300">
                        ...
                        {[
                            {
                                ...
                                endpoints: [
                                    ...
                                    { method: 'GET', path: '/transactions/:id', description: 'Get transaction by ID' },
                            ...
                            },
                            {
                                ...
                                endpoints: [
                                    { method: 'GET', path: '/budgets', description: 'List all budgets' },
                                    { method: 'POST', path: '/budgets', description: 'Create new budget' },
                                    { method: 'GET', path: '/budgets/:id/usage', description: 'Get budget usage stats' },
                                ],
                            },
                            {
                                ...
                                endpoints: [
                                    { method: 'POST', path: '/ai/categorize', description: 'AI categorize transaction' },
                                    { method: 'POST', path: '/ai/feedback', description: 'Submit AI feedback (accept/reject)' },
                                    { method: 'GET', path: '/ai/analytics', description: 'Get AI performance analytics' },
                                    { method: 'POST', path: '/ai/big4-analysis', description: 'Generate Big 4 financial analysis' },
                                ],
                            },
                        ].map((group, index) => {
                            const Icon = group.icon;
                            return (
                                <Card key={index} className="border-none shadow-soft rounded-[28px]">
                                        ...
                                        <div className="space-y-3">
                                            {group.endpoints.map((endpoint, idx) => (
                                                ...
                                                >
                                                    <Badge
                                                        variant="outline"
                                                        className={`font-mono text-xs ${endpoint.method === 'GET'
                    ...
                    <TabsContent value="authentication" className="space-y-6">
                        <Card className="border-none shadow-soft rounded-[28px]">
                            <CardHeader>
                                ...
                                <CardDescription>Secure your API requests with JSON Web Tokens</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div>
                                    <h3 className="font-semibold text-neutral-900 mb-3">1. Login to Get Token</h3>
                                    <div className="bg-neutral-900 text-neutral-100 p-4 rounded-2xl font-mono text-sm overflow-x-auto">
                                ...
                                <div>
                                    <h3 className="font-semibold text-neutral-900 mb-3">2. Include Token in Requests</h3>
                                    <div className="bg-neutral-900 text-neutral-100 p-4 rounded-2xl font-mono text-sm">
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-semibold text-yellow-900 mb-1">Security Best Practices</p>
                                            <ul className="text-sm text-yellow-800 space-y-1">
                                                ...
                                                <li className="flex items-start gap-2">
                                                    <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" />
                                                    <span>Store tokens in httpOnly cookies or secure storage</span>
                                                </li>
                                                <li className="flex items-start gap-2">
                                                    <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" />
                                                    <span>Tokens expire after 1 hour - implement refresh logic</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <TabsContent value="examples" className="space-y-6">
                        <Card className="border-none shadow-soft rounded-[28px]">
                            <CardHeader>
                                ...
                                <CardDescription>Real-world usage examples in JavaScript</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                {[
                                    {
...
// Returns: income, expenses, savings, spending patterns`,
                                    ...
                                    <div key={index}>
                                        <h3 className="font-semibold text-neutral-900 mb-3">{example.title}</h3>
                                        <div className="bg-neutral-900 text-neutral-100 p-4 rounded-2xl font-mono text-sm overflow-x-auto">
                ...
                <div className="mt-16 text-center bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-[32px] p-12">
                    <h3 className="text-2xl font-medium text-neutral-900 mb-3">Need Help?</h3>
                    <p className="text-neutral-600 mb-6 max-w-2xl mx-auto">
                        Have questions about the API? Check out our FAQ or reach out to our developer support team.
                    </p>
