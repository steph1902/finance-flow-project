...
type ApiKeyWithValue = (typeof API_KEYS)[number] & {
...
export default function ApiKeysPage() {
  ...
  const configuredRequired = apiKeys.filter(
    ...
    <div className="container max-w-4xl py-8 space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="type-body text-muted-foreground max-w-2xl">
          Manage your API keys and service integrations. These keys enable core
          features like AI analysis, authentication, and email notifications.
        </p>
      </div>
      ...
      <Alert variant="default" className="border-blue-200 bg-blue-50/50">
        ...
        <AlertDescription>
          <strong>Important:</strong> API keys are stored securely in your
          environment variables. Changes require a server restart to take
          effect. For production deployments, update these in your hosting
