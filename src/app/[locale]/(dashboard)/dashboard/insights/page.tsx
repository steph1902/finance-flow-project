...
export default function InsightsPage() {
  ...
  const getRiskColor = (level: string) => {
    switch (level) {
      case "Safe":
        return "bg-card border-l-green-500 shadow-sm";
      case "Warning":
        return "bg-card border-l-yellow-500 shadow-sm";
      case "Critical":
        return "bg-card border-l-red-500 shadow-sm";
      default:
  ...
  if (!analysis) {
    return (
      <div className="container mx-auto p-6">
        <Alert>
          <AlertDescription>
            No analysis available. Generate one to get started.
          </AlertDescription>
        </Alert>
        <Button onClick={() => fetchAnalysis(true)} className="mt-4">
          Generate Analysis
        ...
        <TabsContent value="overview" className="space-y-4">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {analysis.cashflowDiagnosis.variability}
                  </span>
                </div>
              ...
              <CardContent className="space-y-3">
                {["thirtyDay", "sixtyDay", "ninetyDay"].map((period) => {
                  ...
                  return (
                    <div
                      key={period}
                      className={`p-4 rounded-xl border border-border border-l-[6px] transition-all hover:shadow-md ${getRiskColor(risk.level)}`}
                    >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Specific, measurable actions to improve your financial health
              </CardDescription>
            </CardHeader>
              ...
              {analysis.strategicWeakPoints.structuralIssues.length > 0 && (
                <div>
                  ...
                  <ul className="space-y-2">
                    {analysis.strategicWeakPoints.structuralIssues.map(
                      (issue, idx) => (
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                <div>
                  ...
                  <p className="font-medium">
                    {analysis.strategicWeakPoints.bufferStatus}
                  </p>
                </div>
                <div>
                  <span className="text-sm text-muted-foreground">
                  ...
                  <p className="font-medium">
                    {analysis.strategicWeakPoints.rhythmBalance}
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="cashflow" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed analysis of your cash flow patterns
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="risks" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Forward-looking risk analysis across multiple time horizons
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {["thirtyDay", "sixtyDay", "ninetyDay"].map((period) => {
                ...
                return (
                  <Card
                    key={period}
                    className={`border-l-[6px] ${getRiskColor(risk.level)}`}
                  >
                    <CardHeader>
        ...
        <TabsContent value="recommendations" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Prioritized recommendations to improve your financial health
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {analysis.recommendations.map((rec, idx) => (
                  ...
                  <CardContent className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-card-foreground/90 mt-1">
                          {rec.impact}
                        </p>
                      </div>
                      <div>
