              ...
              {results.significance.isSignificant && (
                <Alert className="border-green-500 bg-green-50 dark:bg-green-950">
                  ...
                  <AlertDescription className="text-green-900 dark:text-green-100">
                    <strong>Statistically Significant!</strong> Winner:{" "}
                    {results.significance.winner}(
                    {results.significance.confidence.toFixed(2)}% confidence, p=
                    {results.significance.pValue.toFixed(4)})
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>
                      {results.control.samples} samples
                    </CardDescription>
                  </CardHeader>
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>
                      {results.variant.samples} samples
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <MetricRow
                ...
                <CardContent>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      ...
                      <div
                        className={`text-2xl font-bold ${getImprovementColor(results.metrics.ratingImprovement)}`}
                      >
                    ...
                    <div className="text-center">
                      ...
                      <div
                        className={`text-2xl font-bold ${getImprovementColor(results.metrics.helpfulImprovement)}`}
                      >
                    ...
                    <div className="text-center">
                      ...
                      <div
                        className={`text-2xl font-bold ${getImprovementColor(results.metrics.actionImprovement)}`}
                      >
