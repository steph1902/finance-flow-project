...
export default function AgentDashboardPage() {
  ...
  const avgExecutionTime =
    decisions.length > 0
      ? Math.round(
          decisions.reduce((sum, d) => sum + d.executionTimeMs, 0) /
            decisions.length,
        )
      : 0;
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Real-time monitoring of AI agents with decision logs and performance
            metrics
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {runningCount === agents.length
                ? "All agents running"
                : `${agents.length - runningCount} stopped`}
            </p>
          </CardContent>
        </Card>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <CardDescription className="text-xs">
                        ...
                        {decision.executionTimeMs}ms execution time
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {decision.actions.map((action: any, idx: number) => (
                          <div
                            key={idx}
                            className="p-3 bg-blue-50 dark:bg-blue-950 rounded-md text-sm"
                          >
                            <div className="flex items-start justify-between gap-2 mb-1">
                              <div className="font-medium">
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    No decision logs yet. Start an agent to see activity.
                  </p>
                </CardContent>
              </Card>
            )}
