...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-cream text-sumi font-sans selection:bg-apricot/30">
      ...
      <a
        href="#main-content"
        className="sr-only-focusable fixed top-4 left-4 z-50 px-4 py-2 bg-apricot text-sumi rounded-lg shadow-lg"
      >
          ...
          >
            ...
            <div className="flex items-center gap-4 md:gap-6">
              <div className="hidden md:flex items-center gap-6">
                <Link
                  href="/ai-guide"
                  className="text-sm text-sumi-500 hover:text-sumi transition-colors"
                >
                  {tNav("aiGuide")}
                </Link>
                <Link
              ...
              <Button
                asChild
                className="bg-apricot hover:bg-apricot-hover text-sumi font-medium rounded-full px-5 h-9 shadow-sm"
              >
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="relative inline-block mt-2">
                  <span className="text-sumi italic">
              ...
              >
                <Button
                  size="lg"
                  asChild
                  className="h-12 px-8 rounded-full bg-apricot hover:bg-apricot-hover text-sumi font-semibold shadow-md hover:shadow-lg transition-all"
                >
                  <Link href="/signup">
                    {t("hero.ctaPrimary")}
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="h-12 px-8 rounded-full border-2 border-border hover:bg-white hover:border-apricot transition-all"
                >
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-lg text-sumi-500 leading-relaxed">
                A <strong>complete, production-ready SaaS boilerplate</strong>{" "}
                for personal finance applications. Built with enterprise-grade
                architecture, AI-powered insights, and bilingual support
                (English/Japanese).
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Complete codebase for frontend, backend, and mobile. No hidden dependencies or vendor lock-in.",
                },
                {
                  icon: Brain,
                  title: "AI Integration",
                  description:
                    "Gemini 1.5 Flash integration for transaction categorization and financial insights.",
                },
                {
                  icon: Smartphone,
                  title: "Cross-Platform",
                  description:
                    "Web app (Next.js), REST API (NestJS), and mobile app (React Native/Expo).",
                },
              ].map((item, i) => (
                <motion.div
                  key={item.title}
                ...
                >
                  ...
                  <p className="text-sumi-500 text-sm leading-relaxed">
                    {item.description}
                  </p>
                </motion.div>
              ))}
          ...
          <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <p className="text-lg text-sumi-500 mb-8">
                Get the complete source code and start building your fintech
                product today.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                  asChild
                  className="h-12 px-8 rounded-full bg-apricot hover:bg-apricot-hover text-sumi font-semibold shadow-md"
                >
                  <Link href="/signup">
                    Get Started
                    <ArrowRight className="w-4 h-4 ml-2" />
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="h-12 px-8 rounded-full border-2 hover:bg-cream"
                >
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-sumi-500">
              <Link href="/docs" className="hover:text-sumi transition-colors">
                Docs
              </Link>
              <Link
                href="/ai-guide"
              ...
              <Link href="/terms" className="hover:text-sumi transition-colors">
                Terms
              </Link>
            </div>
