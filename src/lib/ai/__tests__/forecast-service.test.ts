...
import { ForecastService, ForecastInput, Transaction, RecurringTransaction } from '../forecast-service';
...
describe('ForecastService', () => {
    ...
    const mockTransactions: Transaction[] = [
        { amount: 100, category: 'Food', type: 'EXPENSE', date: new Date(), description: 'Groceries' },
        { amount: 50, category: 'Transport', type: 'EXPENSE', date: new Date(), description: 'Uber' },
        { amount: 100, category: 'Food', type: 'EXPENSE', date: new Date(), description: 'Groceries 2' },
        { amount: 2000, category: 'Salary', type: 'INCOME', date: new Date(), description: 'Paycheck' },
    ];

    const mockRecurring: RecurringTransaction[] = [
        { amount: 1000, category: 'Rent', type: 'EXPENSE', frequency: 'MONTHLY', description: 'Rent' },
    ];
