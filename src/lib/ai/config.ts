...
export const AI_CONFIG = {
  ...
  get model() {
    return ENV.AI_MODEL_VERSION;
  },
  get temperature() {
    return parseFloat(ENV.AI_TEMPERATURE);
  },
  get maxTokens() {
    return parseInt(ENV.AI_MAX_TOKENS);
  },
  topP: 0.8,
  topK: 40,
  get autoAcceptThreshold() {
    return parseFloat(ENV.AI_AUTO_ACCEPT_THRESHOLD);
  },
} as const;
