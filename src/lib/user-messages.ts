...
export const ERROR_MESSAGES = {
  ...
  AUTH_SESSION_EXPIRED:
    "Your session expired - let's log you back in quickly! ⏰",
  AUTH_UNAUTHORIZED:
    "You'll need to log in first to access this. Quick detour! 🚪",

  // Transactions
  TRANSACTION_CREATE_FAILED:
    "Oops! Couldn't save that transaction. Let's give it another shot 🔄",
  TRANSACTION_UPDATE_FAILED: "Update didn't stick - mind trying once more? 💪",
  TRANSACTION_DELETE_FAILED:
    "Couldn't delete that. Maybe refresh and try again? 🗑️",
  TRANSACTION_NOT_FOUND:
    "We can't find that transaction - it might have been deleted 🔍",
  ...
  GOAL_ALREADY_ACHIEVED:
    "You already hit this goal! Time for a new challenge? 🏆",

  // AI
  AI_CATEGORIZATION_FAILED:
    "AI is taking a coffee break ☕ - try manual categorization?",
  AI_CONFIDENCE_LOW:
    "AI isn't very sure about this one. Mind double-checking? 🤔",
  AI_SERVICE_UNAVAILABLE:
    "AI service is temporarily down. We'll categorize manually for now! 🛠️",
  ...
  VALIDATION_REQUIRED_FIELD:
    "This field is required - we need it to continue! ✏️",
  VALIDATION_INVALID_EMAIL: "That doesn't look like a valid email. Typo? 📧",
  VALIDATION_INVALID_AMOUNT:
    "Amount must be a valid number. Check for typos! 🔢",
  VALIDATION_INVALID_DATE:
    "That date format isn't quite right. Try YYYY-MM-DD? 📅",

  // Generic
  SOMETHING_WENT_WRONG:
    "Something went wrong, but you can totally try again! 🔄",
...
export const SUCCESS_MESSAGES = {
  ...
  // AI
  AI_CATEGORIZED:
    "AI did its magic! Categorized with {{confidence}}% confidence ✨",
...
export const EMPTY_STATE_MESSAGES = {
  ...
  NO_BUDGETS: {
    ...
    description:
      "Budgets help you stay on track. Start with your biggest spending category!",
  },
  NO_GOALS: {
    title: "Dream big! Set your first goal 🎯",
    description:
      "Whether it's a vacation, emergency fund, or new gadget - let's make it happen!",
  },
  NO_RECURRING: {
    title: "Automate the boring stuff 🔄",
    description:
      "Set up recurring transactions for bills and subscriptions. Set it and forget it!",
  },
  NO_REPORTS: {
    title: "No reports generated yet 📊",
    description:
      "Generate your first report to see insights into your spending patterns!",
  },
  NO_SEARCH_RESULTS: {
