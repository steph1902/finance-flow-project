...
export function calculateProjectedSavings(
    ...
    const projectedTotalExpenses = currentExpenses + (dailyExpenses * remainingDays);
 ...
 */
export function filterDataByDays(data: DailyTrendPoint[], days: number): DailyTrendPoint[] {
 ...
 */
export function sumFromDataPoints(data: DailyTrendPoint[], field: 'income' | 'expenses'): number {
