...
export function validateAmount(
  ...
  const pattern = mustBePositive
    ? VALIDATION_RULES.positiveAmount.pattern
    : VALIDATION_RULES.amount.pattern;
  const message = mustBePositive
    ? VALIDATION_RULES.positiveAmount.message
    : VALIDATION_RULES.amount.message;
