...
export const AuthBackground = () => {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      {/* Floating Plus Signs */}
      <div className="absolute top-1/4 left-1/3 text-gray-300 text-4xl font-thin">
        +
      </div>
      <div className="absolute bottom-1/3 right-1/2 text-gray-200 text-6xl font-thin rotate-12">
        +
      </div>
    </div>
  );
