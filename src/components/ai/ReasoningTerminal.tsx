...
export function ReasoningTerminal({
    ...
    const demoSteps: ThoughtStep[] = [
        ...
        { id: '2', text: 'Identifying anomalies in spending data...', status: 'pending' },
        { id: '3', text: 'Calculating sector benchmarks...', status: 'pending' },
        { id: '4', text: 'Evaluating risk indicators...', status: 'pending' },
        { id: '5', text: 'Generating personalized recommendations...', status: 'pending' },
    ];
            ...
            <AnimatePresence mode="wait">
                ...
                {showResults && (
                    ...
                    >
                        ...
                        <p className="text-muted-foreground">Your personalized insights are ready.</p>
                    </motion.div>
                )}
            </AnimatePresence>
        </div>
