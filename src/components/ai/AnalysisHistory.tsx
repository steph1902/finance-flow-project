    ...
    <div className="space-y-4">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold">
                {Math.round(
                  records.reduce(
                    (acc, r) => acc + (r.metadata.confidenceScore || 0),
                    0,
                  ) / records.length,
                )}
                %
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and compare your past financial analyses
          </CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    <div className="pt-3 border-t space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-semibold">
                            $
                            {analysis.cashflowDiagnosis.netCashflowAvg.toFixed(
                              2,
                            )}
                          </p>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <div className="flex items-center gap-1 text-sm">
                            {getRiskIcon(
                              analysis.riskProjection.thirtyDay.level,
                            )}
                            <span>30d</span>
                          </div>
                          <div className="flex items-center gap-1 text-sm">
                            {getRiskIcon(
                              analysis.riskProjection.sixtyDay.level,
                            )}
                            <span>60d</span>
                          </div>
                          <div className="flex items-center gap-1 text-sm">
                            {getRiskIcon(
                              analysis.riskProjection.ninetyDay.level,
                            )}
                            <span>90d</span>
                          </div>
                        </div>
