  ...
  return (
    ...
    >
      ...
      <p className="text-base text-neutral-500 text-center max-w-md mb-8">
        Add your first transaction and watch the magic happen. We'll
        auto-categorize it with AI!
      </p>

      <Button
        asChild
        className="h-12 px-8 rounded-full bg-neutral-900 text-white hover:bg-neutral-800 gap-2 shadow-lg shadow-neutral-900/20"
      >
