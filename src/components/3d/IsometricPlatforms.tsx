...
export default function IsometricPlatforms({
  mousePosition,
}: IsometricPlatformsProps) {
  ...
  return (
    <group position={position}>
      ...
      <group position={[0, 0.4, 0]} scale={scale}>
        {object === "coin-stack" && (
          <CoinStack color={color} glowColor={glowColor} />
        )}
        {object === "card" && (
          <CreditCard color={color} glowColor={glowColor} />
        )}
        {object === "chart" && <BarChart color={color} glowColor={glowColor} />}
        {object === "wallet" && <Wallet color={color} glowColor={glowColor} />}
        {object === "dollar" && (
          <DollarSign color={color} glowColor={glowColor} />
        )}
        {object === "trend" && (
          <TrendArrow color={color} glowColor={glowColor} />
        )}
      </group>
