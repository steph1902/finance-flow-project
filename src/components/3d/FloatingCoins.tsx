...
export default function FloatingCoins({ count = 80, mousePosition }: FloatingCoinsProps) {
    ...
    useFrame((state) => {
        ...
        coins.forEach((coin, i) => {
            ...
            const parallaxX = mousePosition.x * 0.5 * ((coin.position[2] as number) / 15);
            const parallaxY = mousePosition.y * 0.5 * ((coin.position[2] as number) / 15);
