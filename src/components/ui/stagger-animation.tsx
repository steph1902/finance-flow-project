...
export interface StaggerContainerProps extends Omit<HTMLMotionProps<"div">, "initial" | "animate" | "viewport"> {
  staggerDelay?: number;
  once?: boolean;
...
export const StaggerContainer = forwardRef<HTMLDivElement, StaggerContainerProps>(
  ({ staggerDelay = 0.1, once = true, enableViewport = true, children, ...props }, ref) => {
